...
//V1: September 15, 2024: 
//Short Summary:
// Top-level architecture of the CPU
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////// MODULE DECLARATION
module CPU_non_pipelined (CLK, RST, ALU_RESULT, WRITE_DATA, WRITE_ENABLE);
// IOs
  input  logic        CLK;       			// Clock	
  input  logic        RST;       			// Reset
	output logic [31:0] ALU_RESULT;			// Data-address for Read / Write to DMEM (or ALU result)
	output logic [31:0] WRITE_DATA;			// The data to be written into DMEM
	output logic 			  WRITE_ENABLE;		// Enable write for DMEM
////// SIGNALS
	logic [31:0] INSTRUCTION;						// Instruction 
	logic [31:0] READ_DATA;							// The data read from DMEM
	logic [31:0] PROGRAM_COUNTER;				// Program counter
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
////// ARCHITECTURE
//// INSTANTIATING AND WIRING THE SUB-MODULES
	SINGLECORE CORE 		 (CLK, RST, INSTRUCTION, READ_DATA, PROGRAM_COUNTER, ALU_RESULT, WRITE_DATA, WRITE_ENABLE);
	IMEM 			 INSTR_MEM (PROGRAM_COUNTER, INSTRUCTION);
	DMEM 			 DATA_MEM  (CLK, ALU_RESULT, WRITE_ENABLE, WRITE_DATA, READ_DATA);
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
// END 
endmodule